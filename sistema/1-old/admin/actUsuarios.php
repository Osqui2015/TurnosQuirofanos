                            ...
                            <div class="tab-pane fade show active" id="pills-Principal" role="tabpanel" aria-labelledby="pills-Principal-tab">                        
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <span id="tiposCreas" hidden = ""> <?php echo $matricula; ?> </span>
                                            <script>
                                                $('#tiposCrea').on('change', function(){
                                                    var valor = this.value;
                                                    $('#tiposCreas').text(valor);                                                                                                
                                                })
                                            </script>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">				
                                    ...
                                    <div class="col-sm-8">
                                        <input id="user2" maxlength="13" type="text" class="form-control" onblur="validUser()">	
                                    </div>
                                </div>
                                <div class="form-group row">				
                                    ...
                                    <table id="user" class="table display" >
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td> <?php 
                                                        if ($row['activacion'] == 1) {
                                                            ?><button type="button" class="btn btn-danger" onclick="DesactivarUser('<?php echo $email ?>')">DESACTIVAR</button>
                                                        <?php }else{ ?>
                                                            <button type="button" class="btn btn-success" onclick="ActivarUser('<?php echo $email ?>')" >ACTIVAR</button>
                                                        <?php } ?>
                                                </td>
                                                <td> <?php 
                                                            switch ($row['tipo']) {
