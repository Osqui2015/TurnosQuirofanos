	...
	$.ajax(
	{
		...
		success:  function (valores) 
		{
			if(valores.existe == "1"){ //A		
				...
				Swal.fire('Error en Crear', '', 'error')
			}
	...
	$.ajax(
	{
				  ...
				  success:  function (valores)
				  {
					if(valores.existe=="1") //A
					{
						...
						Swal.fire('Error en Activar', '', 'error')
					}
				}
	})
	
}
function DesactivarUser(mail){
	console.log (mail);
	var parametros =
	{ "mail": mail,
	  "decUser": "1",
	...
	$.ajax(
	{
				  ...
				  success:  function (valores)
				  {
					if(valores.existe=="1") //A
					{
						...
						Swal.fire('Error en Desactivar', '', 'error')
					}
				}
	})
