...
function fecha(){
	console.log ('fecha Cambio y Quirofano')
...
function confirmarM(){
	...
	horaInicio2 = $("#selectHoraInicio").val(); // Hora inicio
	horaInicio1 = $("#Hinicio").val();
	if (horaInicio1 == ""){
		console.log("Hora Inicio2: "+horaInicio2);
		horaInicio = horaInicio2; // Hora Inicio
	}else{
		console.log("Hora Inicio2: "+horaInicio1);
		horaInicio = horaInicio1; // Hora Inicio
	}
...
function confirmarMidi(){

	horaInicio2 = $("#selectHoraFin").text(); // Hora Inicio
	console.log ("Hora Inicio2: "+horaInicio2);
}

function confirmarMidi2(){
