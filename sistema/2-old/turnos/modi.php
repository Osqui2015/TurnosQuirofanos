...
<input id="vMatricula" value = "<?php echo $matricula; ?>" hidden="">  </input>
        <div class="container">
            <div class="row">
                <div class="col-11">
                                        ...
                                        <div class="tab-pane fade show active" id="v-Fecha-Quirofano" role="tabpanel" aria-labelledby="v-Fecha-Quirofano-tab">
                                                ...
                                                <div class = "row">
                                                    ...
                                                    <div class="col-sm-2">
                                                        ...
                                                        <h6><input id="selectHoraInicio" value ='<?php echo substr($horaI , 11, -3) ?>' disabled> </input></h6> <!-- valor hora inicio -->
