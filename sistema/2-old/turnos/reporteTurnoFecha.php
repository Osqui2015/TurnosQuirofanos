...
$fechaSelec = $_POST['fechaC'];

$query = mysqli_query($conSanatorio, "SELECT tur.Numero,tur.FechaGrabacion, p.Nombre AS Medico, tur.Nombre AS Paciente, tip.Descripcion AS Tipo_Documento, DniPaciente, 
...
INNER JOIN turnosquirofanospracticas tp ON tp.Numero=tur.Numero WHERE DATE_FORMAT(tur.FechaGrabacion,'%Y-%m-%d') = '$fechaSelec'
GROUP BY tur.FechaGrabacion ORDER BY tur.Quirofano,HoraInicio DESC;");
...
<body>
        ...
        <div class="jumbotron ">        
            ...
            <form method="post" action="reporteTurnoFecha.php">
