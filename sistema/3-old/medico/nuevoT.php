                                                    ...
                                                    <div class="card-body">
                                                        <ul class="list-inline">
                                                            ...
                                                            <li class="list-inline-item col-sm-9">
                                                                <select  class="custom-select" required id="menuQuirofano" onchange ="QuirofanoCambio()">                 
                                                                    <option value=""></option>
                                                                    <?php 
                                                        ...
                                                        <ul class="list-inline">
                                                            ...
                                                            <li class="list-inline-item col-sm-8">
                                                                <input onchange="fechaTurno()" type="date" name="fechaSelec" id="fechaSelec" placeholder="Introduce una fecha" required disabled min=<?php $hoy=date("Y-m-d"); echo $hoy;?> />
                                                ...
                                                <div class="col">
                                                    <fieldset class="border p-2 border">
                                                        <legend  class="w-auto ">Practicas</legend>
                                                            ...
                                                            <span id="cod1Practica" hidden = ""></span> <!-- Codigo practica -->
                                        ...
                                        <div class="d-flex justify-content-center">
                                            <ul class="list-inline">
                                                ...
                                                <li class="list-inline-item col-sm-2">
                                                    <select id="Hinicio" class="sele custom-select" disabled required>
                                                    </select>
