...
<body onload="HoraInicioM()" style="background-color:#E9ECEE;">
  ...
  <div class="card-body">
        ...
        <div class="card-body">
                            ...
                            <label for="">Obra Social:</label>
                                <select required class="custom-select" id="menuObraSoc" >    
                                    ...
                                    ?>
                                        ...
                                        <?php else: ?>
                                            <option value="<?php echo $row['Codigo'] ?>"> <?php echo utf8_encode($row['Descripcion']) ?> </option>
                                        <?php endif; ?>
                                    <?php }?>
                                </select>
                                <input id="selectObraSoc" hidden ="" value="<?php echo $obraSocialQ ?> "> 
                                <script>
            ...
            <div class="col text-center" id = "dosForm">
                <button type="button" class="btn btn-success" onclick="chequeaTurno()">GUARDAR TURNO MODIFICADO</button>
            </div>
        </div>
