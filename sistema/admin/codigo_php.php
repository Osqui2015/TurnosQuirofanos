...
/* -------------REGISTRO CARGA DOCTOR---------------- */
	...
	if ($tiposCrea == 2) {
		...
		*/
		$registro = "INSERT INTO usuarios (mail,usuario,PASSWORD,matricula,activacion,tipo,nombre) 
		VALUES ('$email','$usuario',md5('$pass'),$mat,0,$tiposCrea,'$nombre')";

		$resultadoUno = mysqli_query($conUsuario,$registro);

		if (!$resultadoUno) {
			echo "Error Registro: ".$conUsuario->error;
		}else{
			$ok = 1;
		}
	}else {
		...
		VALUES (mail,usuario,PASSWORD,matricula,activacion,tipo,nombre)";
		*/
		$registro = "INSERT INTO usuarios (mail,usuario,PASSWORD,activacion,tipo,nombre) 
		VALUES ('$email','$usuario',md5('$pass'),0,$tiposCrea,'$nombre')";
		...
		if ($ok == 1){
				...
				$mensaje =  "<h2>".'Nuevo Registro PRUEBA de Usuario'."</h2>".
							"<br>"."<br>".
...
/*--- activar usuarios ---*/
	...
	{ 
		...
		$registro = "UPDATE usuarios SET activacion = '1' WHERE mail ='$mail';";

		$resu = mysqli_query($conUsuario,$registro);
...
{ 
	...
	$registro = "UPDATE usuarios SET activacion = '0' WHERE mail ='$mail';";
