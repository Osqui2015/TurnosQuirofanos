...
$userMatri = mysqli_query($conUsuario, "SELECT * FROM usuarios WHERE matricula = $matricula");

while($mat = mysqli_fetch_array($userMatri)) {
    $nombreDoc = $mat['nombre'];
}
?>
<!DOCTYPE html>
<html>
...
<input id="Cpra" value = "<?php echo $cod1Q[0] ?>"  hidden="">  </input> <!-- MATRICULA -->
            ...
            <div >
                        ...
                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                            <div class="card-body"> 
                                <ul class="list-group list-group-horizontal-lg"> <!-- Nuevo Turno Quirofano -->
                                    ...
                                    <li class="list-group-item border-0"><h5><u><?php echo utf8_encode($nombreDoc) ?></u></h5></li>
                                </ul>
                                <ul class="list-group list-group-horizontal-lg"> <!-- Nuevo Turno Quirofano -->
              ...
              <div class="col-md-5">
                  <div class="row">
                      <div class="col-md">
                        <select class="js-pra1-codigo form-control form-control-lg" name="state" id="codPrac1" onchange = "practicaUno()">                                                
                            <?php 
                                    ...
                                    <div id="select2lista">
                                        ...
                                        ?> 
                                            <div class="table-responsive">
                                                <p>ㅤEstadoㅤㅤㅤㅤ Desde ㅤㅤㅤㅤHasta ㅤㅤㅤProfesionalㅤㅤㅤㅤㅤㅤㅤㅤㅤ Practicaㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ</p>
                                                <table class="table">                                                       
                                                    <thead>
                                                        <tr>
                                                            <th scope="col"></th>
                                                    ...
                                                    <tbody>                                                                    
                                                        ...
                                                        <?php while($fila=mysqli_fetch_array($turnTabla)) { ?>
                                                                ...
                                                                <td><?php echo utf8_encode($fila['NomMedico']) ?><td>
                            ...
                            <div class="card-body">
                                <ul class="list-group list-group-horizontal-sm">
                                    ...
                                    <li class="list-group-item border-0">
                                        ...
                                        <input type="number" maxlength="8" name="doc" class="form-control is-invalid" id="doc" value="<?php echo $dniQ ?>"required>
                                    </li>
                                    <li class="list-group-item border-0">
                                        <label> ㅤㅤ</label>
