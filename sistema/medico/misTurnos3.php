        ...
        <div class="card-body">
            <div class="card text-center">
                <div class="card-header">
                    <h4 class="card-title"> 
                        <span class="badge badge-primary"><p class="font-weight-lighter"> Pendiente </p> </span>
                        <span class="badge badge-secondary "> <p class="font-weight-lighter"> No Realizado </p> </span>                
                        <span class="badge badge-success"><p class="font-weight-lighter"> Realizado </p> </span>            
                        <span class="badge badge-danger"><p class="font-weight-lighter"> Suspendido </p> </span>
                    </h4>
                </div>
                <div class="card-body">
            ...
            <div class="card">
                <div class="card-header text-center">
                    <h5>Fecha de Hoy: <?php echo date('d-m-Y'); ?></h5>
                </div>
                <div class="card-body">
                    <div class="table-responsive">    
                        <table class="display compact table table-striped table-hover table-condensed" id="misTurnos">
                            <thead>
